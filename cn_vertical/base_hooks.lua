...
--   cn_vertical.hooks.is_reserved_column = function(col) ... end
--   cn_vertical.hooks.render_reserved_column = function(params) ... end
--
-- 【术语对照 / Terminology】
...
if not _G.cn_vertical.hooks then
    _G.cn_vertical.hooks = hooks
else
    -- Update existing hooks table with our defaults if they are missing
    for k, v in pairs(hooks) do
        if _G.cn_vertical.hooks[k] == nil then
            _G.cn_vertical.hooks[k] = v
        end
    end
    hooks = _G.cn_vertical.hooks
end
