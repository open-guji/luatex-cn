...
\AddToHook{shipout/background}{%
  \ifnum\value{page}=1
    \begin{tikzpicture}[remember picture, overlay]
      \node[anchor=north east, opacity=0.7, inner sep=0pt, xshift=-5.3cm, yshift=-6.4cm] at (current page.north east) {
