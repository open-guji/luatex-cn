...
local function build_sub_params(params, col_aligns)
    ...
    return {
        ...
        -- Padding: top/bottom inset (not inherited to children via style stack)
        padding_top = (params.padding_top and params.padding_top ~= "") and params.padding_top or nil,
        padding_bottom = (params.padding_bottom and params.padding_bottom ~= "") and params.padding_bottom or nil,
